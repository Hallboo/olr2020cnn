...
class Cnn_5layers_AvgPooling(nn.Module):
    ...
    def forward(self, input):
        ...
        x = input
        '''(batch_size, channel, times_steps, freq_bins)'''
...
class Cnn_9layers_AvgPooling(nn.Module):
    ...
    def __init__(self, classes_num, activation):
        ...
        self.conv_block1 = ConvBlock(in_channels=num_in_channels, out_channels=64)
    ...
    def forward(self, input):
        '''
        Input: (batch_size, channel, times_steps, freq_bins)'''
        # print("(batch_size, channel, times_steps, freq_bins)")
        # print(input.shape)
        # import sys
        # sys.exit(1)
        x = input
